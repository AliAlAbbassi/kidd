...
var AccountsServer = /** @class */ (function () {
    ...
    AccountsServer.prototype.resumeSession = function (accessToken) {
        var _a, _b;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var sessionToken, userId, decodedAccessToken, session, user, error_2;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        session = null;
                        if (!!this.options.useStatelessSession) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.db.findSessionByToken(sessionToken)];
                    case 1:
                        session = _c.sent();
                        if (!session) {
                        ...
                        _c.label = 2;
                    case 2: return [4 /*yield*/, this.db.findUserById(userId)];
                    case 3:
                        user = _c.sent();
                        if (!user) {
                            throw new accounts_error_1.AccountsJsError('User not found', errors_1.ResumeSessionErrors.UserNotFound);
                        }
                        return [4 /*yield*/, ((_b = (_a = this.options).resumeSessionValidator) === null || _b === void 0 ? void 0 : _b.call(_a, user, session))];
                    case 4:
                        _c.sent();
                        this.hooks.emit(server_hooks_1.ServerHooks.ResumeSessionSuccess, { user: user, accessToken: accessToken, session: session });
                        return [2 /*return*/, this.sanitizeUser(user)];
                    case 5:
                        error_2 = _c.sent();
                        this.hooks.emit(server_hooks_1.ServerHooks.ResumeSessionError, error_2);
                        throw error_2;
                    case 6: return [2 /*return*/];
                }
            });
